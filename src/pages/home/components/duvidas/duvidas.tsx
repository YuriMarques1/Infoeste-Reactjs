import { Title, Wrapper, FormGroup, FormLabel, SubmitButton, Image, Input, Form } from "./duvidas.styles";
...
export const Duvidas = () => {
  ...
  const handleNome = (event: React.ChangeEvent<HTMLInputElement>) => setNome(event.target.value);

  const handleDuvida = (event: React.ChangeEvent<HTMLInputElement>) => setDuvida(event.target.value);
